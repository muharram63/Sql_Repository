            ...
            <div class="col-lg-8 mb-3 mb-lg-0">
                ...
                <div class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-header">
                        <h4 class="card-header-title">Введите данные</h4>
                    </div>
                    <!-- End Header -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" name="title" placeholder="_Название" value="{{old('title')}}">
                        </div>
                        <!-- End Form -->
             ...
             "toolbar": [
               ["bold", "italic", "underline", "strike", "link", "image", "blockquote", "code", {"list": "bullet"}]
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="theme_id" class="form-control" placeholder="_Название" value="{{old('theme_id')}}">
                            </div>

                        <div class="mb-4">
                            <label class="form-label">Слайд</label>

                           <input type="file" name="slide" class="form-control" value="{{old('slide')}}">
                        </div>
